...
export declare class MeasurerComponent implements OnInit, OnDestroy {
     ...
     * @internal
     */
    hasArea$: BehaviorSubject<boolean>;
    /**
     * Observable of area
     * @internal
     */
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MeasurerComponent, "igo-measurer", never, { "map": "map"; "store": "store"; "activeMeasureType": "activeMeasureType"; "minSegmentLength": "minSegmentLength"; }, {}, never, never>;
}
