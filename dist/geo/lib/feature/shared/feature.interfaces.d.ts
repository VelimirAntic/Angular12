...
export interface FeatureStoreInMapExtentStrategyOptions extends FeatureStoreStrategyOptions {
}
export interface FeatureStoreInMapResolutionStrategyOptions extends FeatureStoreStrategyOptions {
}
