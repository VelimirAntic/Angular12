...
export declare class SearchPointerSummaryDirective implements OnInit, OnDestroy, AfterContentChecked {
   ...
   */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<SearchPointerSummaryDirective, "[igoSearchPointerSummary]", never, { "igoSearchPointerSummaryDelay": "igoSearchPointerSummaryDelay"; "igoSearchPointerSummaryEnabled": "igoSearchPointerSummaryEnabled"; }, {}, never>;
}
/**
 ...
 * @returns OL style function
 */
export declare function pointerPositionSummaryMarker(feature: olFeature<OlGeometry>, resolution: number): olstyle.Style;
